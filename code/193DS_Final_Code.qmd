...
```{r}
log_krat <- log(krat_subset$seeds)
```

```{r}
log_krat <- log_krat[log_krat > 1]
```

```{r}
log_krat_summary <- log_krat %>%
  summarize(
    mean = mean(seeds),
    sd = sd(seeds),
    var = var(seeds),
...
=======
>>>>>>> 4692d2f6c6f516120524ad1a3909459fca287539
```{r}
...
>>>>>>> 93082ee8761ba332da391d34f53da59cd43432a4
seed_subset <- seed_col
