...
seed_mod4 <- glmer(nr_seeds ~ species + total_nr_infl + treatment + (1|treatment), data = seed_col1, family = "poisson")
...
seed_mod5 <- glmer.nb(nr_seeds ~ species + total_nr_infl + treatment + (1|treatment), data = seed_col1)
seed_mod.a <- glmmTMB(nr_seeds ~ species + total_nr_infl + treatment + (1|treatment), data = seed_col1, family = "nbinom2")

seed_mod55 <- glmer.nb(nr_seeds ~ species + total_nr_infl + treatment + (1|total_nr_infl), data = seed_col1)
