...
#reading in data set
kangaroorat <- read_csv(here("data/sev208_kratseedbank_20120213.csv"))
```
...
>>>>>>> f705c2093bbd0443158f0f17252aee431e0b078b
>>>>>>> 10354bf633d95451ec2d66fa03745ef69452baef

```{r model-object}
krat_modelobject <- lm(seeds ~ mnd, data = krat)
```
...
par(mfrow = c(2, 2))
plot(full)
>>>>>>> 876285652f44eadd9fd371e32ef6afdd43e78ba1
```
...
=======
<<<<<<< HEAD
>>>>>>> 64010fa3e31d93eb03080f57859ef537696daf73
