...
```{r remove-negatives}
krat_subset1 <- subset(krat_subset, seeds >= 0)
```
...
=======
Poisson 
>>>>>>> 15bda1756c072ea233c8d6c10384834fefcd1271

```{r poisson-test}
rpois(1560, )
>>>>>>> 5348f5835e9c087c2bca2f6d9aecf3c1944b6d6c
```
...
kruskal.test(seeds ~ loc, data = krat_subset1)
=======
<<<<<<< HEAD
=======
>>>>>>> ecb47ed641eccec35df6d93bba4fe3ef724f5a41
>>>>>>> 15bda1756c072ea233c8d6c10384834fefcd1271
# Perform Kruskal-Wallis test
...
rstatix::kruskal_effsize(seeds ~ loc, data = krat_subset1)
```
...
check_normality(seed_mod2)
check_heteroscedasticity(seed_mod2)

check_normality(seed_mod3)
check_heteroscedasticity(seed_mod3)

check_normality(seed_mod4)
check_heteroscedasticity(seed_mod4)

check_normality(seed_mod5)
check_heteroscedasticity(seed_mod5)
```
